...
const Header: React.FC = () => {
  ...
  "
              >
                <span className="text-custom-text-title">Personificamos</span>{" "}
                Operações{" "}
                <span className="text-custom-text-title">Customizadas</span> à
                Sua <span className="text-custom-text-title">Necessidade</span>
              </h1>
              <p
            ...
            "
              >
                Vou mostrar como você pode investir na estruturação do seu
                negócio sem precisar fazer grandes aportes de capital próprio ou
                comprometer seu fluxo de caixa com operações inflexíveis e de
                alto custo.
              </p>
            </div>
