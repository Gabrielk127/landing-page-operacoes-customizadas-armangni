    ...
    >
      <h2
        className="text-lg text-center font-bold pt-8 text-white
              ...
              "
      >
        Nosso crédito é a opção mais{" "}
        <span className="text-custom-text-title">viável</span>,{" "}
        ...
        <span className="text-custom-text-title">lucrativo</span>, e se tornar{" "}
        <span className="text-custom-text-title">referência</span> em seu{" "}
        mercado.
      </h2>
      <p
        className="text-base text-center mt-4 font-normal text-white
            ...
            "
      >
        As aplicações para o crédito inteligente são diversas e incluem:
      </p>
